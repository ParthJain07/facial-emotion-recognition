...
function LiveCapture() {
  ...
  return (
    <>
    {!showLive && <div className='bg-gra-02 d-flex justify-content-center align-items-center' style={{ height: '100vh' }}><Button onClick={()=>setShowLive(true)}>Start</Button></div>}
    {showLive && (<div className="App">
      <Webcam
          ref={webcamRef}
          style={{
            position: "absolute",
